    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.html"><img src="assets/auth/images/logo.svg" alt="logo" /></a>
          <a class="navbar-brand brand-logo-mini" href="index.html"><img src="assets/auth/images/logo-mini.svg" alt="logo" /></a>
        </div>
          ...
          <ul class="navbar-nav navbar-nav-right">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="assets/auth/images/faces/face4.jpg" alt="image" class="profile-pic">
                  </div>
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="assets/auth/images/faces/face2.jpg" alt="image" class="profile-pic">
                  </div>
                  <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="assets/auth/images/faces/face3.jpg" alt="image" class="profile-pic">
                  </div>
                  <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
            ...
            <li class="nav-item nav-logout d-none d-lg-block">
               <form id ="logout_form" method="post" action = "{{ route('logout') }}">
                    @csrf
                    <a  id ="logout_button" class="nav-link" href="#">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="post">
                <span class="menu-title">IMAGE AND TEXT</span>
            ...
            <div class="row">
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    <img src="assets/auth/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img src="assets/auth/images/faces/face1.jpg" class="me-2" alt="image"> David Grey
                            </td>
                          ...
                          <tr>
                            <td>
                              <img src="assets/auth/images/faces/face2.jpg" class="me-2" alt="image"> Stella Johnson
                            </td>
                          ...
                          <tr>
                            <td>
                              <img src="assets/auth/images/faces/face3.jpg" class="me-2" alt="image"> Marina Michel
                            </td>
                          ...
                          <tr>
                            <td>
                              <img src="assets/auth/images/faces/face4.jpg" class="me-2" alt="image"> John Doe
                            </td>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex mt-5 align-items-top">
                      <img src="assets/auth/images/faces/face3.jpg" class="img-sm rounded-circle me-3" alt="image">
